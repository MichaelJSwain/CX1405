const CX1405 = {
    ...
    getButtonText: () => {
        ...
        if (!selectedSizes.includes("{}")) {
            ...
            buttonText = isInStock ? `${CX1405.copy.a2b} ${userSelection}` : CX1405.copy.notify;
        } else {
